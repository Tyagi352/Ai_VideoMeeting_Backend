...
io.on("connection", (socket) => {
  ...
  //   console.log("User joining room:", roomId, socket.id);
  ...
  socket.on(
    ...
    (roomId) => {
      ...
      // Clean up maps so this socket can rejoin later
      socketRoomMap.delete(socket.id);
      userSocketMap.delete(socket.id);

      // Clean up host mapping if this socket was the host
  ...
  socket.on("disconnect", () => {
    ...
    for (const [room, host] of roomHostMap.entries()) {
